  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80 px-6 py-16 shadow-2xl shadow-lime-500/10 sm:px-10">
      ...
      <div className="relative z-10 max-w-3xl">
        <p className="mb-4 inline-flex rounded-full border border-lime-400/40 bg-lime-400/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-lime-300">
